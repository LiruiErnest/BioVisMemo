...
function showVisualization(data) {
	...
	for (var i = 0; i < data.length; i++) {
		var img_thumburl = data[i].url;
		var img_url = data[i].url;
		var img_score = parseFloat(data[i].score).toFixed(2);
		var img_HR = parseFloat(data[i].HR).toFixed(2);
		var img_FAR = parseFloat(data[i].FAR).toFixed(2);
